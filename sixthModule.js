...
//   const murkup = `<div class="log-item"><span class="chip">${keypressCounter}</span>
//     <ul>
...
//   logList.insertAdjacentHTML("afterbegin", murkup);
...
// const murkup = technologies
//   .map((technologies) => `<li class="list-item">${technologies}</li>`)
//   .join("");
...
// console.log(image.setAttribute("alt", "Amazing nature"));
